...
pub use protocol::{
    ...
    encode_mit_command, encode_parameter_read, encode_parameter_write, ext_id_parts,
    CommunicationType, FaultFlags, FaultReport, PingReply, StatusFlags, StatusFrame, WarningFlags,
};
pub use registers::{
