...
// Non-0x7xxx manual/factory/diagnostic function-code entries are preserved
// below as comments for reference. The active table intentionally exposes only
// protocol section 4 runtime single-parameter IDs (0x7005..0x702E).
